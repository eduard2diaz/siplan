                    ...
                    else
                    {
                        ...
                        objeto = table.row.add({
                            ...
                            "acciones": "<ul class='m-nav m-nav--inline m--pull-right'>" +
                                ...
                                "<a class='btn btn-sm edicion' data-href=" + Routing.generate('arc_edit',{id:data['id']}) + "><i class='flaticon-edit-1'></i>Editar</a></li>" +
                                "<li class='m-nav__item'>" +
                                "<a class='btn btn-danger btn-sm  eliminar_arc' data-href=" + Routing.generate('arc_delete',{id:data['id']}) + ">" +
